...
public class ReturningShopperFullBillingWithShippingTests extends CheckoutEspressoBasedTester {
    ...
    public void returning_shopper_full_billing_with_shipping_common_tester() {
    ...
    @Test
    public void returning_shopper_full_billing_with_shipping_test_1() {
        returning_shopper_full_billing_with_shipping_common_tester();
    }

    @Test
    public void returning_shopper_full_billing_with_shipping_test_2() {
        returning_shopper_full_billing_with_shipping_common_tester();
    }

    @Test
    public void returning_shopper_full_billing_with_shipping_test_3() {
        returning_shopper_full_billing_with_shipping_common_tester();
    }

    @Test
    public void returning_shopper_full_billing_with_shipping_test_4() {
        returning_shopper_full_billing_with_shipping_common_tester();
    }

    @Test
    public void returning_shopper_full_billing_with_shipping_test_5() {
        returning_shopper_full_billing_with_shipping_common_tester();
    }

    @Test
    public void returning_shopper_full_billing_with_shipping_test_6() {
        returning_shopper_full_billing_with_shipping_common_tester();
    }

    @Test
    public void returning_shopper_full_billing_with_shipping_test_7() {
        returning_shopper_full_billing_with_shipping_common_tester();
    }

    @Test
    public void returning_shopper_full_billing_with_shipping_test_8() {
        returning_shopper_full_billing_with_shipping_common_tester();
    }
