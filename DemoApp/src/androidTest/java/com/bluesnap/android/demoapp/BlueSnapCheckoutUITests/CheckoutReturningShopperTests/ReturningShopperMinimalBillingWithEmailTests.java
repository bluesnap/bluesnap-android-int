...
public class ReturningShopperMinimalBillingWithEmailTests extends CheckoutEspressoBasedTester {
    ...
    public void returning_shopper_minimal_billing_with_email_common_tester() {
    ...
    @Test
    public void returning_shopper_minimal_billing_with_email_test_1() {
        returning_shopper_minimal_billing_with_email_common_tester();
    }

    @Test
    public void returning_shopper_minimal_billing_with_email_test_2() {
        returning_shopper_minimal_billing_with_email_common_tester();
    }

    @Test
    public void returning_shopper_minimal_billing_with_email_test_3() {
        returning_shopper_minimal_billing_with_email_common_tester();
    }

    @Test
    public void returning_shopper_minimal_billing_with_email_test_4() {
        returning_shopper_minimal_billing_with_email_common_tester();
    }

    @Test
    public void returning_shopper_minimal_billing_with_email_test_5() {
        returning_shopper_minimal_billing_with_email_common_tester();
    }

    @Test
    public void returning_shopper_minimal_billing_with_email_test_6() {
        returning_shopper_minimal_billing_with_email_common_tester();
    }

    @Test
    public void returning_shopper_minimal_billing_with_email_test_7() {
        returning_shopper_minimal_billing_with_email_common_tester();
    }

    @Test
    public void returning_shopper_minimal_billing_with_email_test_8() {
        returning_shopper_minimal_billing_with_email_common_tester();
    }
    ...
    public void billing_contact_info_content_validation() {
        ...
        ContactInfoTesterCommon.contact_info_content_validation("billing_contact_info_content_validation in " + returningShopper.getShippingContactInfo(),
                applicationContext, R.id.billingViewComponent, returningShopper.getBillingContactInfo().getCountryKey(), false, true, returningShopper.getBillingContactInfo());
    }
