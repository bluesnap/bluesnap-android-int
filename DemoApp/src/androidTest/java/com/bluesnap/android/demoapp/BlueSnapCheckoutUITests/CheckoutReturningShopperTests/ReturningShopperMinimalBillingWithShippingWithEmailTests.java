...
public class ReturningShopperMinimalBillingWithShippingWithEmailTests extends CheckoutEspressoBasedTester {
    ...
    public void returning_shopper_minimal_billing_with_shipping_with_email_common_tester() throws IOException {
        ...
        if (ReturningShoppersFactory.COUNTER == 4) { //minimal billing with shipping and email returning shopper
    ...
    public void component_opens_when_pressing_buyNow_with_missing_info() {
        ReturningShopperVisibilityTesterCommon.component_opens_when_pressing_buyNow_with_missing_info("component_opens_when_pressing_buyNow_with_missing_info in " + returningShopper.getShopperDescription(), false, true, true, returningShopper);
    }
}
